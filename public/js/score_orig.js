...
// use amdefine module in order to use requirejs with node
...
//                if (underscore.findWhere(list[id], topElm) == null) {
//                    list[id].push(topElm);
//                }
//                if (underscore.findWhere(list[topElm], id) == null) {
//                    list[topElm].push(id);
//                }
...
//</editor-fold>
    ...
    var _getIntersectedVal = function (xlist, ylist) {
        ...
        intersection = underscore.intersection(xlist, ylist);
